...
class Scenario(BaseScenario):
    def make_world(self):
        ...
        self.prey_size = 0.05
        # [vel+pos+relative pos to all landmarks+relative pos to agents -i + velocity of preys], 2+2+2X2+2X7+2x2=26
        self.local_state_size = 26
    ...
    def observation(self, agent, world):
        ...
        # 2+2+2*(num_landmarks:2)+2*(num_agents-1)+2*2=26
