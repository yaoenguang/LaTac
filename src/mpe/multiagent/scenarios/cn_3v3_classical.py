...
class Scenario(BaseScenario):
    def make_world(self):
        ...
        self.local_state_size = 18  # [vel+pos+relative pos to all landmarks+relative pos and comm to agents -i], 2+2+2x3+2x2+2x2=18
        self.state_size = int(self.local_state_size * self.num_agents)      # 18x3=54
        # the episode length
