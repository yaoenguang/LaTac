...
if __name__ == '__main__':
    ...
    # params.append("env_args.map_name=5m_vs_6m")
    params.append("env_args.map_name=6h_vs_8z")
    # params.append("env_args.map_name=corridor")
    # params.append("env_args.map_name=MMM2")
    # params.append("env_args.map_name=2c_vs_64zg")
    # params.append("env_args.map_name=3s5z_vs_3s6z")
    # params.append("env_args.map_name=3s5z")
